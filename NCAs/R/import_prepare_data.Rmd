...
params:
  ...
  pred_bound: 
    ...
    value: ../data/peaty_soils/Peaty_Soils_buff_200m.shp
  NP: 
    input: select
  ...
  obs_path:
    ...
    value: ../data/peat_depth_data/Combined_Peat_Depth_Survey_Data_NOV2012_ALLDATA.shp
  projection:
    input: text
...
if(parameters$raster_source == "TerrainTiles"){
  zoom <- 12
  elevation_orig <- get_elev_raster(locations = site_bound, z = zoom, clip = "locations")

...
In parameterised RMarkdown scripts all the user defined parameters are declared in the yaml header, and when the command `knit_with_parameters('R/main.Rmd')` is given:  
